...
import {AuthAction, SignInData, SignUpData, SET_USER, User, SET_LOADING, SET_ERROR, SET_SUCCESS, SIGN_OUT, NEED_VERIFICATION} from '../types'
    ...
    return async dispatch => {
      try {
        ...
        if (err instanceof FirebaseError) {
            // `err` is now of type `FirebaseError`
            console.log(err);
            onError();
            dispatch({
              type: SET_ERROR,
